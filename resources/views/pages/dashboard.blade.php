...
<x-layout>
            ...
            <div class="flex flex-wrap -mx-3 mb-24">
                    ...
                    <div class="relative bg-gray-50">
                        ...
                        <a class="block" href="#">
                            <img class="w-full h-64 object-cover"
                                src="/yofte-assets/images/placeholder-basketball-player.png" alt="">
                        </a>
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 lg:mb-0">
                    <div class="relative bg-gray-50">
                        ...
                        <a class="block" href="#">
                            <img class="w-full h-64 object-cover" src="/yofte-assets/images/placeholder-cream.png"
                                alt="">
                        </a>
                        <div class="px-6 pb-6 mt-8">
                            <a class="block px-6 mb-2" href="#">
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 md:mb-0">
                    <div class="relative bg-gray-50">
                        <span
                            class="absolute top-0 left-0 ml-6 mt-6 px-2 py-1 text-xs font-bold font-heading bg-white border-2 border-red-500 rounded-full text-red-500">-15%</span>
                        <a class="block" href="#">
                            <img class="w-full h-64 object-cover" src="/yofte-assets/images/placeholder-surfing-blue.png"
                                alt="">
                        </a>
                        <div class="px-6 pb-6 mt-8">
                            <a class="block px-6 mb-2" href="#">
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 px-3">
                    <div class="relative bg-gray-50">
                        ...
                        <a class="block" href="#">
                            <img class="w-full h-64 object-cover" src="/yofte-assets/images/placeholder-gym.png"
                                alt="">
                        </a>
                        <div class="px-6 pb-6 mt-8">
                            <a class="block px-6 mb-2" href="#">
    ...
    <section class="relative py-20 md:py-32 bg-blue-800 overflow-x-hidden">
        <img class="absolute h-24 md:h-auto top-0 left-0 right-0" src="/yofte-assets/elements/line-top.svg"
            alt="">
        ...
        <div class="flex flex-wrap lg:flex-nowrap justify-center">
            <div class="hidden lg:block opacity-50 flex-shrink-0 w-full max-w-md px-3">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="absolute top-0 left-0" src="/yofte-assets/elements/quote.svg" alt="">
                        <img class="absolute top-0 right-0" src="/yofte-assets/elements/quote.svg" alt="">
                        <div class="px-4 md:px-10">
                            ...
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="/yofte-assets/images/placeholder-portrait.png" alt="">
                ...
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        ...
                        <div class="px-4 md:px-10">
                            ...
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="/yofte-assets/images/placeholder-young.png" alt="">
                                <p class="mb-6 md:mb-0 text-gray-300">Alice Kenowski, NYC</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        ...
                        <div class="px-4 md:px-10">
                            ...
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="/yofte-assets/images/placeholder-anna.png" alt="">
            ...
            <div class="hidden lg:block opacity-50 flex-shrink-0 w-full max-w-md px-3">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="hidden md:block absolute top-0 left-0" src="/yofte-assets/elements/quote.svg"
                            alt="">
                        <img class="hidden md:block absolute top-0 right-0" src="/yofte-assets/elements/quote.svg"
                            alt="">
                        <div class="px-4 md:px-10">
                            <h3 class="mb-8 text-xl font-bold font-heading text-white">Thanks, feugiat tellus a sad
                                tincidunt ultrices. Phasellus non libero tempus odio vestibulum ultricies.</h3>
