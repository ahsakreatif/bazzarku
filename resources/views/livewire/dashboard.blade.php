...
<div>
    <section class="relative">
        <div class="relative container mx-auto px-4">
            ...
            <div class="hidden lg:flex absolute right-0 top-1/2 transform -translate-y-1/2 flex-col items-center">
                ...
                <button class="mb-5">
                    <img src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/circle.svg" alt="">
                </button>
            ...
            <div class="relative flex flex-wrap -mx-4">
                <div class="w-full md:w-1/2 px-4 mb-12 lg:mb-0 pt-20 lg:pt-32 pb-32 lg:pb-64">
                    <div class="max-w-md">
                        <h2 class="mb-8 text-5xl lg:text-6xl font-semibold font-heading">Empowering Connections Between
                ...
                <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 lg:mb-0">
                    <div class="relative h-full text-center pt-16 bg-white">
                        <img class="hidden md:block absolute z-10 top-0 left-1/2 ml-16 lg:ml-8 mt-16"
                            src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/dots.svg" alt="">
        ...
        <div class="container px-4 mx-auto">
            ...
            <div class="flex flex-wrap -m-3">
                <div class="w-full md:w-1/2 lg:w-1/3 p-3">
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                ...
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Esther Howard</h3>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 p-3">
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                src="https://images.unsplash.com/photo-1449247526693-aa049327be54?ixlib=rb-1.2.1&amp;ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80"
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Robert Fox</h3>
                            <p class="text-gray-500">CEO &amp; Founder</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                ...
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Danny Bailey</h3>
                            <p class="text-gray-500">CEO &amp; Founder</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                ...
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Cameron Williamson</h3>
                            <p class="text-gray-500">CEO &amp; Founder</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                ...
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Ralph Edwards</h3>
                            <p class="text-gray-500">CEO &amp; Founder</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center justify-center border p-12 rounded-xl">
                        <div class="text-center">
                            <img class="w-20 h-20 mx-auto rounded-full mb-6 object-cover"
                                ...
                                alt="">
                            <h3 class="mb-1 text-2xl font-semibold font-heading">Darrell Steward</h3>
                            <p class="text-gray-500">CEO &amp; Founder</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="relative py-20 md:py-32 bg-blue-800 overflow-x-hidden">
        <img class="absolute h-24 md:h-auto top-0 left-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/line-top.svg"
            alt="">
        <div class="relative container px-4 mx-auto mb-20 lg:mb-40">
            <div class="flex flex-wrap items-center">
                <h2 class="mb-10 lg:mb-0 w-full lg:w-auto text-5xl text-white font-bold font-heading">What Customers Say
                </h2>
                <div class="flex w-full lg:w-auto lg:ml-auto">
                    <a class="mr-5 flex items-center justify-center w-12 h-12 bg-orange-300 hover:bg-orange-400 rounded-md"
                        href="#">
                    ...
                    <a class="flex items-center justify-center w-12 h-12 bg-blue-300 hover:bg-blue-400 rounded-md"
                        href="#">
                        <svg width="8" height="12" viewbox="0 0 8 12" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
        ...
        <div class="flex flex-wrap lg:flex-nowrap justify-center">
            <div class="hidden lg:block opacity-50 flex-shrink-0 w-full max-w-md px-3">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="absolute top-0 left-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <img class="absolute top-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <div class="px-4 md:px-10">
                            <h3 class="mb-8 text-xl font-bold font-heading text-white">Thanks, feugiat tellus a sad
                                tincidunt ultrices. Phasellus non libero tempus odio vestibulum ultricies.</h3>
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/images/placeholder-portrait.png" alt="">
            ...
            <div class="flex-shrink-0 w-full lg:max-w-md px-3 lg:mt-20 mb-6 lg:mb-0">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="absolute top-0 left-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <img class="absolute top-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <div class="px-4 md:px-10">
                            <h3 class="mb-8 text-xl font-bold font-heading text-white">Tonight I had interdum at ante
                                porta, eleifend feugiat nunc. In semper euismod me a accumsan. Thanks! 👏💥</h3>
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/images/placeholder-portrait.png" alt="">
                                <p class="mb-6 md:mb-0 text-gray-300">TIA O’Halleran, NYC</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="flex-shrink-0 w-full lg:max-w-md px-3 mb-6 lg:mb-0">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="absolute top-0 left-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <img class="absolute top-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <div class="px-4 md:px-10">
                            ...
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/images/placeholder-young.png" alt="">
                                <p class="mb-6 md:mb-0 text-gray-300">Alice Kenowski, NYC</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex-shrink-0 w-full lg:max-w-md px-3 lg:mt-20 mb-6 lg:mb-0">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        ...
                        <img class="absolute top-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg" alt="">
                        <div class="px-4 md:px-10">
                            <h3 class="mb-8 text-xl font-bold font-heading text-white">This time ut augue ut magna rutrum
                                ultricies nec nec leo. Proin tempor, mauris sad senne lorem.</h3>
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mb-4 md:mb-0 mr-6 rounded-full"
                                    src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/images/placeholder-anna.png" alt="">
                                <p class="mb-6 md:mb-0 text-gray-300">Lea Diamse, NYC</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="hidden lg:block opacity-50 flex-shrink-0 w-full max-w-md px-3">
                <div class="px-8 py-16 border border-white">
                    <div class="relative px-4 mx-auto">
                        <img class="hidden md:block absolute top-0 left-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg"
                            alt="">
                        <img class="hidden md:block absolute top-0 right-0" src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/elements/quote.svg"
                            alt="">
                        <div class="px-4 md:px-10">
                            <h3 class="mb-8 text-xl font-bold font-heading text-white">Thanks, feugiat tellus a sad
                                tincidunt ultrices. Phasellus non libero tempus odio vestibulum ultricies.</h3>
                            <div class="flex flex-wrap items-center">
                                <img class="w-16 h-16 mr-6 rounded-full"
                                    src="{{ config('filesystems.public_cdn')}}/shuffle/yofte-assets/images/placeholder-portrait.png" alt="">
                                <p class="mb-6 md:mb-0 text-gray-300">TIA O’Halleran, NYC</p>
                            </div>
                        </div>
