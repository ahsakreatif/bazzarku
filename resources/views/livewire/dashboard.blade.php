    ...
    <section class="mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="relative h-72 rounded-lg overflow-hidden group cursor-pointer" onclick="openEventModal()">
                <img src="https://placehold.co/800x400/333/FFFFFF/png" alt="Stage Equipment"
                    class="w-full h-full object-cover">
            ...
            <div class="relative h-72 rounded-lg overflow-hidden group cursor-pointer" onclick="openEventModal()">
                <img src="https://placehold.co/800x400/666/FFFFFF/png" alt="Decor"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end">
            ...
            <!-- Small Cards Row -->
            <div class="relative h-72 rounded-lg overflow-hidden group cursor-pointer" onclick="openEventModal()">
                <img src="https://placehold.co/800x400/555/FFFFFF/png" alt="Booths"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="relative h-[140px] rounded-lg overflow-hidden group cursor-pointer"
                    onclick="openEventModal()">
                    <img src="https://placehold.co/800x200/777/FFFFFF/png" alt="Transportation"
                        class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end">
                ...
                <div class="relative h-[140px] rounded-lg overflow-hidden group cursor-pointer"
                    onclick="openEventModal()">
                    <img src="https://placehold.co/800x200/999/FFFFFF/png" alt="Catering"
                        class="w-full h-full object-cover">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-black/20 flex items-end">
