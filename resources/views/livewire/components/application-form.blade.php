<div>
    ...
    <!-- Modal Trigger -->
    <button wire:click="openModal" class="flex items-center justify-center gap-2 w-full bg-green-500 text-white py-3 rounded-lg font-medium hover:bg-green-600 transition duration-200">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="mt-4 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="tel" wire:model="phone" id="phone" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                        ...
                                        <div>
                                            ...
                                            <textarea wire:model="note" id="note" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
