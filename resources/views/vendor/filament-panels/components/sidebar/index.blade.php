...
>
    <div class="overflow-x-clip">
        <header
            class="fi-sidebar-header flex h-40 items-center bg-white px-6"
        >
            <div
    ...
    <nav
        class="fi-sidebar-nav flex-grow flex flex-col gap-y-7 overflow-y-auto overflow-x-hidden px-6 py-8 bg-white"
